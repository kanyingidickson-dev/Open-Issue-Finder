...
import { Search, Hash, Code2, Layers, RefreshCcw, ChevronDown, X } from 'lucide-react';
...
export const FilterBar: React.FC<FilterBarProps> = ({ onFilterChange, isLoading, isOpen = false, onClose }) => {
        ...
        <>
            ...
            <aside className={`sidebar ${isOpen ? 'mobile-open' : ''}`}>
                <div className="sidebar-header">
                    ...
                    {/* Mobile Close Button */}
                    <button
                        className="lg:hidden ml-auto p-2 text-text-muted hover:text-white"
                        onClick={onClose}
                    >
                        <X size={20} />
                    </button>
